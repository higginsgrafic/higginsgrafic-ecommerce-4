  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-center" style={{ gap: styles.gap }}>
        ...
        <Link to={productUrl} className="block">
          <h3
            className="font-oswald font-medium uppercase hover:opacity-70 transition-opacity text-gray-900 leading-tight tracking-tight"
            style={{
        ...
        {styles.showDescription && (
          <div style={{ minHeight: 'clamp(4.5rem, 9vw, 5.25rem)' }}>
            <p
              className="font-roboto font-light text-gray-700 leading-snug text-left"
              style={{
